      ...
      <div>
        <div className={classes.root}>
          <CustomAppBar position="static">
            <Toolbar>
              ...
              <Button color="inherit" onClick={this.onVersionModalShow} >v20200206</Button>
            </Toolbar>
          </CustomAppBar>
        </div>
        ...
        >
          <div style={{ textAlign:'left' }}>
            <p>发布日期: 2020-02-06</p>
            <p>本次更新增加 欠款明细查询</p>
            <p>历史版本信息请查看 <a href="https://github.com/88fantasy/mobile-assistant/releases" target="_blank" >这里</a></p>
          </div>
        </Modal>
      </div>
    );
